...
$_ADDONLANG['Backups']['Warning'] = 'Для каждого сервера доступно семь слотов для резервных копий. Если все слоты заполнены, самая старая резервная копия будет удалена.';
